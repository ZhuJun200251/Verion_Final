...
public:
    ...
    void BulletMove(int speed = 80);              //子弹移动函数
    ...
    void SetGrade(int grade);                //设置防御塔的等级
    void SetBulletWidthHeight(int, int);    //设置子弹宽高
    virtual DefeTowerParent* GetTypeid();

    virtual ~DefeTowerParent() {}
};
