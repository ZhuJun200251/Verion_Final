...
private:
    ...
    int id;                      //怪物编号
    int health;                  //怪物生命值
    int health_max;         //怪物最大生命值
    int mspeed = 10;               //怪物移动速度
    int speed_max;      //怪物最初移动速度

public:
    //参数：路径点数组、路径点的个数、怪物初始坐标、怪物宽度、怪物类别
    ...
    int GetSpeed() const;  //获取移动速度
    int GetSpeed_Max() const;  //获取初始速度
    QString GetImgPath() const; //获取图片路径
    int GetId() const;      //获取编号
    int GetHealth() const;  //获取生命值
    int GetHealth_Max() const; //获取初始生命值
    void SetHealth(int);    //设置生命值
    void SetSpeed(int);     //设置移动速度
};
